<?php
/**
 * Template Name: Cultura Brasileira
 */
...
<div id="esquerda-home">
				...
				<?php $cat_cultura_brasileira = get_category_by_slug('cultura-brasileira');
				$cat_cultura_brasileira = $cat_cultura_brasileira->term_id; ?>
                <?php query_posts( 'showposts=4&cat='.$cat_cultura_brasileira.'' ); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
<?php echo $ido; ?>
