<?php
/**
 * Template Name: Centro de Formacao
 */
...
<div id="esquerda-home">
				...
				<?php $cat_centro_formacao = get_category_by_slug('centro-de-formacao');
				$cat_centro_formacao = $cat_centro_formacao->term_id; ?>
                <?php query_posts( 'showposts=4&cat='.$cat_centro_formacao.'' ); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
